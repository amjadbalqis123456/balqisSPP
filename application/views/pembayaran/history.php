                    ...
                    <div class="card p-0 col-lg-12">
                        <div class="card-body">
                            <div class="form-group p-2 d-flex">
                                ...
                                <input type="text" class="form-control col-md-6 mr-3" id="keyword" name="keyword">
                                <button type="button" id="btn-search" class="btn btn-primary col-md-2 mt-n1">Cari</button>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                            <div class="card-header">
                                              <h3 class="card-title text-bold">Tagihan Pembayaran</h3>      
                            </div>
                                <div class="card-body">
