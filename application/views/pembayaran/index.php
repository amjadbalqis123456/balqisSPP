...
<div class="content-wrapper">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('pembayaran/transaksispp') ?>" method="get">
                                <div class="form-group p-2 d-flex">
                                    ...
                                    <input type="text" class="form-control col-md-6 mr-3" id="search" name="search">
                                    <button type="submit" class="btn button-cari btn-primary col-md-2 mt-n1">Cari</button>
    ...
    <!-- untuk menampilkan data di entri transaksi -->
           <div class="card">
                <div class="card-body">
